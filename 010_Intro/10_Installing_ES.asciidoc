...
TIP: On Microsfot Windows you must install Java JDK (not just Java JRE) and set JAVA_HOME environment variable to the JDK path.
...
TIP: In Microsoft Windows you must double quotes instead of single quotes in the curl commands. 
      For example: curl "http://localhost:9200/?pretty"
